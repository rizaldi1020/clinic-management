...
<style>
    ...
    .text-muted { color: #718096; font-size: .8rem; }
...
<div class="card" style="max-width: 600px;">
    <form action="{{ route('user.update', $user) }}" method="POST">
        ...
        <div style="border-top: 1px dashed #e2e8f0; margin: 1.5rem 0; padding-top: 1rem;">
            <p class="text-muted" style="margin-bottom: 1rem;">Isi password baru jika ingin mengubah password. Biarkan kosong jika tidak ingin mengubah.</p>
