...
@section('breadcrumb', 'Admin / Janji Temu / Buat')
    ...
    <form action="{{ route('appointment.store') }}" method="POST">
        ...
        <div class="form-group">
            ...
            <select name="doctor_id" id="doctor_id" class="form-control" required disabled>
                ...
                <!-- Opsi dokter dimuat via Ajax berdasarkan Poli -->
            </select>
...
<script>
    $(document).ready(function() {
            ...
            if (deptId) {
                $.get('/api/department/' + deptId + '/doctors', function(data) {
                    $.each(data, function(index, doctor) {
                        var selected = oldDoctorId == doctor.id ? 'selected' : '';
        ...
        // Trigger change to load old doctors on validation error
