...
@section('breadcrumb','Admin / Obat / Tambah')
    ...
    <form method="POST" action="{{ route('obat.store') }}">
        ...
        <div class="form-grid">
            ...
            <div class="form-group">
                ...
                @error('price')<p class="invalid-msg">{{ $message }}</p>@enderror
            </div>
            <div class="form-group form-full">
                <label>Deskripsi / Keterangan</label>
                <textarea name="description" rows="2" placeholder="Indikasi, kontraindikasi, dll…">{{ old('description') }}</textarea>
            </div>
        </div>
